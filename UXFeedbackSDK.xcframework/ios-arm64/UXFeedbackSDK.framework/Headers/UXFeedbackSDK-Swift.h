...
@property (nonatomic, strong) UIColor * _Nonnull iconDisabledColor;
...
///
- (NSString * _Nonnull)startCampaignWithEventName:(NSString * _Nonnull)eventName attributes:(NSArray<Attribute *> * _Nullable)attributes localProps:(NSDictionary<NSString *, id> * _Nullable)localProps SWIFT_WARN_UNUSED_RESULT;
