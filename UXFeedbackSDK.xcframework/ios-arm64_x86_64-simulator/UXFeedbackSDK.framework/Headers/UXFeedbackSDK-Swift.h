...
///
- (void)startCampaignWithEventName:(NSString * _Nonnull)eventName attributes:(NSArray<Attribute *> * _Nullable)attributes localProps:(NSDictionary<NSString *, id> * _Nullable)localProps;
