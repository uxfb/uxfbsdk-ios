...
SWIFT_CLASS("_TtC13UXFeedbackSDK9Attribute")
@interface Attribute : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC13UXFeedbackSDK17AttributesBuilder")
@interface AttributesBuilder : NSObject
...
- (void)campaignDidShowWithCampaignId:(NSInteger)campaignId eventName:(NSString * _Nonnull)eventName invocationId:(NSString * _Nonnull)invocationId;
- (void)campaignDidCloseWithCampaignId:(NSInteger)campaignId eventName:(NSString * _Nonnull)eventName invocationId:(NSString * _Nonnull)invocationId;
- (void)campaignDidTerminateWithCampaignId:(NSInteger)campaignId eventName:(NSString * _Nonnull)eventName terminatedPage:(NSInteger)terminatedPage totalPages:(NSInteger)totalPages invocationId:(NSString * _Nonnull)invocationId;
- (void)campaignDidSendWithCampaignId:(NSInteger)campaignId invocationId:(NSString * _Nonnull)invocationId;
- (void)campaignDidAnsweredWithCampaignId:(NSInteger)campaignId answers:(NSDictionary<NSString *, id> * _Nonnull)answers invocationId:(NSString * _Nonnull)invocationId;
- (void)noCampaignToStartWithEventName:(NSString * _Nonnull)eventName invocationId:(NSString * _Nonnull)invocationId;
@end
...
SWIFT_CLASS("_TtC13UXFeedbackSDK21UXFBAttributesBuilder")
@interface UXFBAttributesBuilder : AttributesBuilder
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UIColor * _Nonnull iconSmile4Color;
@property (nonatomic, strong) UIColor * _Nonnull skeletonBase;
@property (nonatomic, strong) UIColor * _Nonnull skeletonShine;
@property (nonatomic, strong) UIColor * _Nonnull bgDisabled;
@property (nonatomic, strong) UIColor * _Nonnull fgDisabled;
@property (nonatomic, strong) UIColor * _Nonnull borderDisabled;
...
@property (nonatomic, strong) UIFont * _Nonnull fontCaption;
...
///
/// \param attributes Аттрибуты показа кампании
///
- (NSString * _Nullable)startCampaignWithEventName:(NSString * _Nonnull)eventName attributes:(NSArray<Attribute *> * _Nullable)attributes localProps:(NSDictionary<NSString *, id> * _Nullable)localProps SWIFT_WARN_UNUSED_RESULT;
...
- (void)addGlobalPropertyWithKey:(NSString * _Nonnull)key value:(id _Nonnull)value;
/// Метод добавления глобального property
- (void)removeGlobalPropertyWithKey:(NSString * _Nonnull)key;
/// Метод удаления глобального property
- (void)clearGlobalProperties;
/// Метод удаления всех глобальных properties
- (NSDictionary<NSString *, id> * _Nonnull)getGlobalProperties SWIFT_WARN_UNUSED_RESULT;
@end
